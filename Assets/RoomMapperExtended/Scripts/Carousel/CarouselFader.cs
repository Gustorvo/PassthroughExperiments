...
namespace VRoom
{
    ...
    public class CarouselFader : MonoBehaviour
    {
        ...
        [SerializeField] private float _maxTimeActive = 1.5f; // max time when

        private float _lerpTime => _activate ? _lerpInTime : _lerpOutTime;
        private CarouselMenu _menu;
        private CarouselMover _mover;
        ...
        private void Awake()
        {
            ...
            _mover = GetComponent<CarouselMover>();
