...
public class XRControllerInput : MonoBehaviour
{
    ...
    private float TriggerValueAction
    {
        ...
        set
        {
            ...
            Debug.Log($"Trigger Value {triggerValue} on {XRController}");
        }
    }
    ...
    private float GripValueAction
    {
        ...
        set
        {
            ...
            Debug.Log($"Grip Value {Mathf.RoundToInt(gripValue * 100) / 100} on {XRController}");
        }
    }
    ...
    private Vector2 Primary2DAxisValueAction
    {
        ...
        set
        {
            ...
            Debug.Log($"Primary2DAxis value {primary2DAxisValue} on {XRController}");
        }
    }
    ...
    private Vector2 Secondary2DAxisValueAction
    {
        ...
        set
        {
            ...
            Debug.Log($"Secondary2DAxis value {secondary2DAxisValue} on {XRController}");
        }
    }
